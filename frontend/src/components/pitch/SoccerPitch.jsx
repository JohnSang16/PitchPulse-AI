  ...
  return (
    <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "0", fontFamily: MONO }}>
      ...
      <svg viewBox="-15 -12 630 464" style={{ width: "100%", display: "block" }}>
        ...
        {/* Corner kick boxes */}
        <rect x="20"  y="20"  width="16" height="16" fill="none" stroke="#1a2e1a" strokeWidth="0.5" />
        <rect x="564" y="20"  width="16" height="16" fill="none" stroke="#1a2e1a" strokeWidth="0.5" />
        <rect x="20"  y="404" width="16" height="16" fill="none" stroke="#1a2e1a" strokeWidth="0.5" />
        <rect x="564" y="404" width="16" height="16" fill="none" stroke="#1a2e1a" strokeWidth="0.5" />
